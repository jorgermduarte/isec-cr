...
% Casos de Teste
% Criando um objeto da classe ModeloTreino
arrayModelos = [];
...
for i = 1:numel(arrayModelos)
    ...
    resultsCell(end+1, :) = {modeloTreino.numCamadas, mat2str(modeloTreino.numNeuronios), strjoin(modeloTreino.funcoesAtivacao, ' '), modeloTreino.funcaoDeTreino, modeloTreino.epochs, modeloTreino.divisaoFuncao, modeloTreino.divisaoValores{1}, modeloTreino.divisaoValores{2}, modeloTreino.divisaoValores{3}, accuracy, accuracyTeste};
 
end

% Salvar a tabela como um arquivo CSV
results = cell2table(resultsCell, 'VariableNames', {'NumberLayres', 'NumberNeurons', 'ActivationFunctions', 'TrainingFunction', 'Epochs', 'Division', 'TrainRatio', 'ValRatio', 'TestRatio', 'Accuracy' , 'TestAccuracy'});
